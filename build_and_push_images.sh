...
docker build \
-t d0rka/authentication-service-backend-proxy:latest \
-t d0rka/authentication-service-backend-proxy:$SHA \
-t d0rka/authentication-service-backend-proxy:$VERSION \
-f ./backend-proxy/Dockerfile ./backend-proxy
docker build \
-t d0rka/authentication-service-frontend:latest \
-t d0rka/authentication-service-frontend:$SHA \
-t d0rka/authentication-service-frontend:$VERSION \
