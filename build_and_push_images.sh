...
docker build -t d0rka/authentication-service-backend-proxy:latest -t d0rka/authentication-service-backend-proxy:$SHA -t d0rka/authentication-service-backend-proxy:$VERSION -f ./backend/Dockerfile.dev ./backend
